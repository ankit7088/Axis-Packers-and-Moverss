...
const CONTACT_MESSAGE_FIELDS = {
  ...
  message: "Message",
  date:"Date",
  relocationFrom:"Relocation From",
  relocationTo:"Relocation To"
};
...
async function handler(req, res) {
  ...
  return ;
      ...
      try {
        ...
        return res.status(200).json({userData:response ,successMessage: "Your message has been sent. Thank you!" });
      } catch (err) {
        console.log(err);
